...
const Fashion = () => {
    ...
    console.log("From Fashion :", fetchingSuccessful)

    // Filter posts based on the category (e.g., 'lifestyle')
    const FashionPosts = fetchingSuccessful.filter((post) => post.Category === 'Fashion');

    console.log("Culture Posts:", FashionPosts);
    ...
    return (
        <div className="bg-[#142030] w-full h-full px-4 md:px-16 py-8">
            <div className="bg-[#5469d4] w-full p-8 ">
                <h1 className="text-2xl md:text-4xl text-slate-200 text-center">FASHION</h1>
            </div>
            <div className=" grid md:grid-cols-3 gap-6 mt-8  ">
                <div className="col-span-2 bg-opacity-20 bg-gray-500 p-4 h-fit">
                    <div className="w-full my-5">
                        {FashionPosts && FashionPosts.map((post) =>(
